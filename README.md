...
<body>
  ...
  <script>
    ...
    const FRASES_POR_NIVEL = {
      5: [
        "Empezaste suave, pero lo importante es que arrancaste 💪",
        "Todo campeón fue novato alguna vez 😄",
        "Poco a poco se llena el saco",
        "El cuerpo todavía está preguntando qué está pasando 😂",
        "Tranquilo, esto es solo el calentamiento",
        "Lo bueno no es cuántas veces fuiste, sino que fuiste",
        "Aquí no se juzga, se progresa",
        "El espejo ya te está conociendo",
        "La pesa aún no te extraña… pero espérate",
        "Nivel inicial desbloqueado 🔓"
      ],

      4: [
        "Ya esto no es relajo, se te ve la constancia 👀",
        "El gym ya sabe quién tú eres",
        "Ni principiante ni animal, pero vas bien",
        "El cuerpo empieza a responder",
        "Aquí ya hay compromiso",
        "Te extrañan cuando no vas",
        "El espejo empieza a respetarte",
        "Las agujetas son parte de la familia",
        "Estás en el punto peligroso: si paras, se pierde",
        "Sigue así que la cosa se pone buena"
      ],
      3: [
        "Esto ya es disciplina, no motivación 🔥",
        "El gym es tu segunda casa",
        "Si no vas un día, algo no cuadra",
        "El cuerpo ya sabe la rutina",
        "Aquí hay sacrificio real",
        "No hace falta hablar, los resultados hablan",
        "Constancia nivel serio",
        "Ya te miran raro los nuevos",
        "El espejo asiente con la cabeza",
        "Respeto ganado a pulso"
      ],
      2: [
        "Esto ya es otra liga 🦍",
        "Las pesas te saludan primero a ti",
        "Si faltas, preguntan por ti",
        "Aquí no hay excusas",
        "El sudor ya es parte del outfit",
        "El cuerpo ya no negocia descanso",
        "Modo animal activado",
        "Esto no es gym, es templo",
        "La disciplina te tiene miedo",
        "Nivel leyenda en progreso"
      ],
      1: [
        "Esto no es constancia, es devoción 🏆",
        "El gym abre por ti",
        "Las máquinas te respetan",
        "Tu ausencia se siente",
        "Aquí se entrena aunque llueva",
        "El espejo ya no opina, aplaude",
        "Esto ya es cultura física",
        "Leyenda urbana del gimnasio",
        "No entrenas, impartes clases",
    ...
    function generateImage() {
      ...
      ctx.fillText("Frase del año", pad + 26, panelY + 60);
